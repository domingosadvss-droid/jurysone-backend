...
description: Realiza auditoria de conformidade com a LGPD (Lei 13.709/2018), elabora RIPD, mapeamento de dados (ROPA), políticas de privacidade e planos de resposta a incidentes de segurança. Use quando o usuário pedir análise de conformidade LGPD, política de privacidade, RIPD, mapeamento de dados pessoais ou resposta a incidente/vazamento de dados.
---

# LGPD e Proteção de Dados

## Visão geral
Apoia auditorias de conformidade com a LGPD para clientes do escritório (empresas) e para o próprio escritório (que trata dados sensíveis de clientes em processos). Cobre desde o mapeamento inicial de dados até a resposta a incidentes.
...
2. **Auditoria de conformidade** — checklist:
   - Existe política de privacidade acessível e atualizada?
   - Cada tratamento tem base legal identificada e documentada?
   - Há mecanismo para o titular exercer seus direitos (acesso, correção, exclusão, portabilidade)?
...
## Alertas
- Nunca afirmar que uma empresa está "100% conforme" sem auditoria completa — sempre apresentar o resultado como um diagnóstico com gaps identificados e plano de ação.
- Dados sensíveis (saúde, origem racial, orientação sexual, dados de crianças/adolescentes) exigem base legal mais restrita (art. 11) — sinalizar sempre que aparecerem no mapeamento.
- Sigilo profissional da advocacia (documentos de clientes, estratégia processual) deve ser tratado com camada extra de segurança, já que envolve dados sensíveis de terceiros e segredo de justiça em muitos casos.
